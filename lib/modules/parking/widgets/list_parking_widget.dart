        ...
        SliverPadding(
          ...
          sliver: Obx(() {
            return SliverGrid.builder(
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 4, childAspectRatio: 0.95),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: Colors.white,
                                          border: Border.all(color: isAvailable ? Colors.green : Colors.red, width: 4),
                                        ...
                                        Expanded(
                                          child: Visibility(
                                            ...
                                            replacement: ElevatedButton.icon(
                                              onPressed: () {
                                                Get.back();
                                                final response = controller.finalizeParkingReservation(parkingSpace);
                                                  ...
                                                  return ElevatedButton.icon(
                                                    onPressed: !isValid
                                                        ...
                                                        : () {
                                                            Get.back();
                                                            final response =
                                                                controller.createParkingReservation(parkingSpace);
                                                            if (response.isSuccess) {
                                                              CustomSnackbar.showMessageSuccess(
